...
class WC_Unit_Tests_Bootstrap {
	...
	/** @var string plugin directory (WooCommerce root) */
	public $plugin_dir;

	/** @var string Path to WordPress plugins */
	public $plugins_dir;
	...
	public function __construct() {
		define( 'WP_PHPUNIT_TESTING', true );

		$this->tests_dir  = dirname( __FILE__ );
		$this->plugins_dir = dirname( dirname( dirname( dirname( $this->tests_dir ) ) ) );
		$this->plugin_dir = $this->plugins_dir . '/woocommerce';
		...
		$this->wp_tests_dir = $this->plugins_dir . '/ribarich-shop-extensions/vendor/wp-phpunit/wp-phpunit';
		...
		// load Ribarich Shop Extensions
		tests_add_filter( 'muplugins_loaded', array( $this, 'load_ribarich_se' ) );
	...
	public function load_ribarich_se() {
		require $this->plugins_dir . '/ribarich-shop-extensions/ribarich-shop-extensions.php';
	}
